...
def panel():
  ...
  <div style="display:flex;align-items:center;gap:14px">
    <div style="display:flex;flex-direction:column;gap:2px"><div style="display:flex;align-items:baseline;gap:10px"><span style="font-size:22px;font-weight:700;color:%(ink)s">李梓轩</span><span style="font-size:13px;color:%(mute)s">02 · LIM, BRENDAN TYLER SO</span></div>
